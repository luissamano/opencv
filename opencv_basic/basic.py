...
# IMPRIMIR VERSION DE OPENCV
print(cv2.__version__)


# LECTURA DE IMAGENES
img_color = cv2.imread('images/img.png', 1) # Imagen con color y se elimina la transparencia.
img_grayscale = cv2.imread('images/img.png', 0) # Imagen en escala de grises.
img_unchanged = cv2.imread('images/img.png', -1) # Imagen tal como es sin eliminar la transparencia.
